...
vi.mock("@/components/DemoLabPanel", () => ({ DemoLabPanel: () => <div>Demo lab panel</div> }));
...
describe("localized page", () => {
  it("renders PawPass in English", () => {
    ...
    expect(screen.getByText("Pet form")).toBeInTheDocument();
    expect(screen.getByText("Pet list")).toBeInTheDocument();
    expect(screen.getByText("Demo lab panel")).toBeInTheDocument();
  });
